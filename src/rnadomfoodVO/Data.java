...
public class Data {
    ...
    public List<RestaurantDto> makeList(){
        ...
        restaurantDtos.add(new RestaurantDto("포탈라레스토랑", "양식", "인도음식", "02-318-0094",
                "서울 종로구 관철동 35-2", "카레, 스프, 국수", "서울 종로구 청계천로 99", "http://place.map.kakao.com/11834063",
                "11834063","포탈라레스토랑.png"));
        ...
        restaurantDtos.add(new RestaurantDto("반쿤콴", "양식", "태국음식", "02-725-1688",
        ...
        restaurantDtos.add(new RestaurantDto("촌놈숯불닭갈비", "한식", "닭갈비", "02-722-3852",
                "서울 종로구 관철동 6-4", "닭목살구이, 허브숙성양념", "서울 종로구 삼일대로19길 6", "http://place.map.kakao.com/1750296031",
                "1750296031","촌놈숯불닭갈비.png"));
